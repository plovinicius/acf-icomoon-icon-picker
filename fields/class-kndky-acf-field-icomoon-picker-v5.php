...
if( !class_exists('kndky_acf_field_icomoon_picker') ) :


class kndky_acf_field_icomoon_picker extends acf_field {
	...
	*/
	...
	function __construct( $settings ) {
		...
		*/
		...
		$this->label = __('Icomoon Picker', 'kndky');
		...
		*/
		...
		$this->l10n = array(
			'error'	=> __('Error! Please enter a higher value', 'kndky'),
		);
...
// initialize
new kndky_acf_field_icomoon_picker( $this->settings );
